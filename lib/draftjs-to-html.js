...
function getEntityMarkup(entityMap, entityKey, text, customEntityTransform) {
  ...
  if (entity.type === 'IMAGE') {
    var imgAlignment = entity.data.alignment || 'center';
    var imgHeight = entity.data.height == 'auto' ? '100%' : entity.data.height;
    var imgWidth = entity.data.width == 'auto' ? '100%' : entity.data.width;
